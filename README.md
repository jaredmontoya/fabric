...
<img src="./.github/media/fabric-logo-gif.gif" alt="fabriclogo" width="400" height="400"/>
...
This will allow you to use the patterns as aliases like in the above for example `summarize` instead of `fabric --pattern summarize --stream`, however if you pass in an extra argument like this `summarize "my_article_title"` your output will be saved in the destination that you set in `obsidian_base="/path/to/obsidian"` in the following format `YYYY-MM-DD-my_article_title.md` where the date gets auto-generated for you. 
...
```bash
go install github.com/danielmiessler/fabric/pkg/plugins/tools/to_pdf@latest
```
